...
class ROCKAD():
    ...
    def init(self, X):
        ...
        self.Xtp = None # X: values, t: transformed, p: power transformed
        
        if self.transform is True:
            # power transformation
            self.Xtp = pd.DataFrame(self.power_transformer(Xt))
    ...
    def predict_proba(self, X):
        ...
        if self.transform == True:
            ...
            Xtp_scaled = X.astype(np.float32)
